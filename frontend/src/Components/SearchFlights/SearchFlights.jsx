...
export default function SearchFlights() {
  ...
  const handleSearch = (e) => {
    ...
    // Build query string for Kiwi widget
  ...
  return (
    <form onSubmit={handleSearch} style={{ display: "flex", flexWrap: "wrap", gap: "16px", paddingTop: "42px" }}>
      <div>
        <label>From*</label>
        <input
          type="text"
          ...
          required
          style={{ padding: "8px", borderRadius: "50px", borderColor: "black", width: "200px" }}
        />
      </div>
      <div>
        <label>To*</label>
      ...
      <div>
        ...
        <input
          ...
          required
          style={{ padding: "8px", borderRadius: "50px", borderColor: "black" }}
        />
      </div>
      <div>
        <label>Return</label>
      ...
      <div>
        ...
        <input
          ...
          style={{ padding: "8px", borderRadius: "50px", borderColor: "black", width: "80px" }}
        />
      </div>
      <div>
        <button
